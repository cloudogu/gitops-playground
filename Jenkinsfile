...
properties([
        ...
        parameters([
                ...
                choice(name: 'chooseProfile', choices: ['all profiles', 'full', 'full-prefix', 'content-examples', 'minimal', 'operator-full', 'operator-minimal'], description: 'Starts GOP with given profile only and execute tests which belongs to profile.')
        ])
])
