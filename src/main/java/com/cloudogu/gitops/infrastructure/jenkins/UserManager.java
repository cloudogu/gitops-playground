...
public class UserManager {
    ...
    public boolean isUsingMatrixBasedPermissions() {
        ...
        return "class hudson.security.GlobalMatrixAuthorizationStrategy".equals(result) ||
                "class hudson.security.ProjectMatrixAuthorizationStrategy".equals(result);
    }
    ...
    public boolean isUsingSecurityRealmWithoutLocalUserCreation() {
        ...
        return List.of("class org.jenkinsci.plugins.cas.CasSecurityRealm",
                       "class org.jenkinsci.plugins.oic.OicSecurityRealm").contains(result);
    }
