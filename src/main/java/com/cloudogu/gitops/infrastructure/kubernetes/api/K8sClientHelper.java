...
class K8sClientHelper {
  ...
  static io.fabric8.kubernetes.client.dsl.Resource<? extends HasMetadata> getResourceClient(
  ...
  static io.fabric8.kubernetes.client.dsl.Resource<? extends HasMetadata> getCustomResourceClient(
