...
public class RoleBinding {
  ...
  public RoleBinding(
      String name, String namespace, String roleName, List<ServiceAccountRef> serviceAccounts) {
  ...
  public Map<String, Object> toTemplateParams() {
    return Map.of(
        ...
        "roleName", roleName,
        "roleKind", roleKind,
        "serviceAccounts", serviceAccounts.stream().map(ServiceAccountRef::toMap).toList());
  }
