...
public class Config {
  ...
  public static class ContentSchema {
    ...
    @JsonPropertyDescription() private List<HelmReleaseSchema> helmReleases = new ArrayList<>();

    @Option(
        names = {"--content-whitelist"},
        description = CONTENT_STATICSWHITELIST_ENABLED_DESCRIPTION)
    ...
    private Set<String> allowedStaticsWhitelist =
        new HashSet<>(
            Arrays.asList(
                "java.lang.String",
                "java.lang.Integer",
  ...
  public static class JenkinsSchema {
    ...
    @Option(
        names = {"--jenkins-additional-envs"},
        description = JENKINS_ADDITIONAL_ENVS_DESCRIPTION,
        split = ",",
        required = false)
    ...
    @Option(
        names = {"--jenkins-namespace"},
        description = JENKINS_NAMESPACE)
  ...
  public static class ApplicationSchema {
    ...
    @Option(
        names = {"--config-map"},
        description = CONFIG_MAP_DESCRIPTION,
        split = ",")
    ...
    @Option(
        ...
        description = OUTPUT_CONFIG_FILE_DESCRIPTION,
        help = true)
    ...
    @Option(
        names = {"-v", "--version"},
        help = true,
        description = "Display version and license info")
    ...
    @Option(
        names = {"--insecure"},
        description = INSECURE_DESCRIPTION)
    ...
    @Option(
        names = {"-y", "--yes"},
        description = PIPE_YES_DESCRIPTION)
    @JsonPropertyDescription(PIPE_YES_DESCRIPTION)
    private Boolean yes = false;

    @Option(
        names = {"--name-prefix"},
        description = NAME_PREFIX_DESCRIPTION)
  ...
  public static class ArgoCDSchema {
    ...
    @Option(
        names = {"--argocd"},
        description = ARGOCD_ENABLE_DESCRIPTION)
    @JsonPropertyDescription(ARGOCD_ENABLE_DESCRIPTION)
    private Boolean active = false;

    @Option(
        names = {"--argocd-operator"},
        description = ARGOCD_OPERATOR_DESCRIPTION)
    @JsonPropertyDescription(ARGOCD_OPERATOR_DESCRIPTION)
    private Boolean operator = false;

    @Option(
        names = {"--argocd-url"},
        description = ARGOCD_URL_DESCRIPTION)
  ...
  public static class MailSchema {
    ...
    @Option(
        names = {"--smtp-address"},
        description = SMTP_ADDRESS_DESCRIPTION)
    ...
    @Option(
        names = {"--smtp-user"},
        description = SMTP_USER_DESCRIPTION)
  ...
  public static class MonitoringSchema {
    @Option(
        names = {"--metrics", "--monitoring"},
        description = MONITORING_ENABLE_DESCRIPTION)
    @JsonPropertyDescription(MONITORING_ENABLE_DESCRIPTION)
    private Boolean active = false;

    @Option(
        names = {"--grafana-url"},
        description = GRAFANA_URL_DESCRIPTION)
    @JsonPropertyDescription(GRAFANA_URL_DESCRIPTION)
    private String grafanaUrl = "";

    @Option(
        names = {"--grafana-email-from"},
        description = GRAFANA_EMAIL_FROM_DESCRIPTION)
    @JsonPropertyDescription(GRAFANA_EMAIL_FROM_DESCRIPTION)
    private String grafanaEmailFrom = "grafana@example.org";

    @Option(
        names = {"--grafana-email-to"},
        description = GRAFANA_EMAIL_TO_DESCRIPTION)
    ...
    public MonitoringSchema() {
      ...
      // renovate: depName=kube-prometheus-stack
  ...
  public static class SecretsSchema {
    ...
    @Option(
        names = {"--secrets-namespace"},
        description = SECRETS_NAMESPACE)
    ...
    public static class ESOSchema {
      ...
      public static class ESOHelmSchema extends HelmConfigWithValues {
        @Option(
            names = {"--external-secrets-image"},
            description = EXTERNAL_SECRETS_IMAGE_DESCRIPTION)
        @JsonPropertyDescription(EXTERNAL_SECRETS_IMAGE_DESCRIPTION)
        private String image = "";

        @Option(
            names = {"--external-secrets-certcontroller-image"},
            description = EXTERNAL_SECRETS_CERT_CONTROLLER_IMAGE_DESCRIPTION)
        @JsonPropertyDescription(EXTERNAL_SECRETS_CERT_CONTROLLER_IMAGE_DESCRIPTION)
        private String certControllerImage = "";

        @Option(
            names = {"--external-secrets-webhook-image"},
            description = EXTERNAL_SECRETS_WEBHOOK_IMAGE_DESCRIPTION)
    ...
    public static class VaultSchema {
      ...
      public static class VaultHelmSchema extends HelmConfigWithValues {
        @Option(
            names = {"--vault-image"},
            description = VAULT_IMAGE_DESCRIPTION)
  ...
  public static class IngressSchema {
    @Option(
        names = {"--ingress"},
        description = INGRESS_ENABLE_DESCRIPTION)
    ...
    @Option(
        names = {"--ingress-namespace"},
        description = INGRESS_NAMESPACE)
    ...
    public static class IngressHelmSchema extends HelmConfigWithValues {
      @Option(
          names = {"--ingress-image"},
          description = HELM_CONFIG_IMAGE_DESCRIPTION)
  ...
  public static class CertManagerSchema {
    @Option(
        names = {"--cert-manager"},
        description = CERTMANAGER_ENABLE_DESCRIPTION)
    @JsonPropertyDescription(CERTMANAGER_ENABLE_DESCRIPTION)
    private Boolean active = false;

    @Option(
        names = {"--cert-manager-issuer"},
        description = CERTMANAGER_ENABLE_DESCRIPTION)
    @JsonPropertyDescription(CERTMANAGER_ENABLE_DESCRIPTION)
    private String issuer = "cluster-selfsigned";

    @Option(
        names = {"--cert-manager-namespace"},
        description = CERTMANAGER_NAMESPACE)
    ...
    public static class CertManagerHelmSchema extends HelmConfigWithValues {
      ...
      @Option(
          names = {"--cert-manager-webhook-image"},
          description = CERTMANAGER_WEBHOOK_IMAGE_DESCRIPTION)
      @JsonPropertyDescription(CERTMANAGER_WEBHOOK_IMAGE_DESCRIPTION)
      private String webhookImage = "";

      @Option(
          names = {"--cert-manager-cainjector-image"},
          description = CERTMANAGER_CAINJECTOR_IMAGE_DESCRIPTION)
      @JsonPropertyDescription(CERTMANAGER_CAINJECTOR_IMAGE_DESCRIPTION)
      private String cainjectorImage = "";

      @Option(
          names = {"--cert-manager-acme-solver-image"},
          description = CERTMANAGER_ACME_SOLVER_IMAGE_DESCRIPTION)
      @JsonPropertyDescription(CERTMANAGER_ACME_SOLVER_IMAGE_DESCRIPTION)
      private String acmeSolverImage = "";

      @Option(
          names = {"--cert-manager-startup-api-check-image"},
          description = CERTMANAGER_STARTUP_API_CHECK_IMAGE_DESCRIPTION)
                  ...
                  new BeanSerializerModifier() {
                    ...
                    public List<BeanPropertyWriter> changeProperties(
                      ...
                      return beanProperties.stream()
                          .filter(
                              writer -> writer.getAnnotation(JsonPropertyDescription.class) != null)
                          .toList();
                    }
                  }));
      return mapper;
