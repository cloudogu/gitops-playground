...
public static final String CENTRAL_ARGOCD_NAMESPACE_DESCRIPTION =
	"Namespace for the centralized Argocd";
public static final String CENTRAL_USEDEDICATED_DESCRIPTION =
	"Toggles the Dedicated Instances Mode. See docs for more info";
...
@Option(
	names = {"--central-argocd-namespace"},
	description = CENTRAL_ARGOCD_NAMESPACE_DESCRIPTION)
@JsonPropertyDescription(CENTRAL_ARGOCD_NAMESPACE_DESCRIPTION)
private String centralArgocdNamespace = "argocd";

@Option(
	names = {"--dedicated-instance"},
	description = CENTRAL_USEDEDICATED_DESCRIPTION)
