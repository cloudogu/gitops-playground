...
public class ContextBuilder {
	...
	private DeploymentContext.ScmManagerDeploymentMode scmManagerDeploymentMode() {
		boolean internal = config.getScm() != null && config.getScm().getScmManager() != null && config.getScm()
		                                                                                               .getScmManager()
		                                                                                               .getInternal();
		return internal ? DeploymentContext.ScmManagerDeploymentMode.INTERNAL : DeploymentContext.ScmManagerDeploymentMode.EXTERNAL;
	}
