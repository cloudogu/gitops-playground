...
public class ScmManager extends Tool {
    ...
    private static final Logger log = LoggerFactory.getLogger(ScmManager.class);
    ...
    private ScmManagerProvider getTenantScmManager() {
        ...
        if (!(tenantScm instanceof ScmManagerProvider)) {
            throw new IllegalStateException("Tenant SCM provider is not an SCM-Manager. Actual provider: " +
