...
/**
 * JGit, a project used within eclipse, is developed with an interactive UI in mind. The
 * documentation for the CredentialsProvider says > CredentialItems are usually presented in bulk,
 * allowing implementors to combine them into a single UI widget and streamline the authentication
 * process for an end-user. This highlights the focus on the UI for an end-user.
 *
 * <p>As a result, checking for SSL verification is a little clunky as we need to check for messages
 * intended for end-users.
 *
 * <p>Other options would have included overwriting the HttpConnection or saving the git
