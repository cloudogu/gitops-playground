...
public class NetworkingUtils {
	...
	public String findClusterBindAddress() {
		...
		if (potentialClusterBindAddress == null || potentialClusterBindAddress.isEmpty()) {
			throw new IllegalStateException("Could not connect to kubernetes cluster: no cluster bind address");
		}
	...
	public String getLocalAddress() {
		try {
			List<NetworkInterface> sortedInterfaces = Collections.list(NetworkInterface.getNetworkInterfaces());
