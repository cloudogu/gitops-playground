...
class TemplatingEngine {
    ...
    void replaceTemplates(File path, Map parameters, Pattern filepathMatches = ~/\.ftl/) {
        String disclaimer = '''# -----------------------------------------------------------------------------
# DISCLAIMER: This file is autogenerated.
# 
# Please **DO NOT** edit this file manually. Any changes will be overwritten 
# during the next generation.
#
# To overwrite values, use the already created "custom-helm-values.yaml".
...
'''
        ...
        Files.walk(path.toPath())
                ...
                .each { Path filePath ->
                    ...
                    String newContent = disclaimer + "\n" + originalContent
                    replaceTemplate(file, parameters)
