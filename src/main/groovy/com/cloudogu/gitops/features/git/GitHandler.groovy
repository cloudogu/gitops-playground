    ...
    void init() {
        ...
        switch (config.scm.scmProviderType) {
            ...
            case ScmProviderType.SCM_MANAGER:
                this.tenant = new ScmManager(this.config, config.scm.scmmConfig, this.helmStrategy, fileSystemUtils)
        ...
        switch (config.multiTenant.scmProviderType) {
            case ScmProviderType.GITLAB:
                ...
                break
            case ScmProviderType.SCM_MANAGER:
                this.central = new ScmManager(this.config, config.multiTenant.scmmConfig, this.helmStrategy, fileSystemUtils)
                break
            default:
