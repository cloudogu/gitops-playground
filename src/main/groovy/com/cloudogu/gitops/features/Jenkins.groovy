...
class Jenkins extends Feature {
    ...
    void enable() {
        ...
        commandExecutor.execute("${fileSystemUtils.rootDir}/scripts/jenkins/init-jenkins.sh", [
                ...
                SCM_URL                 : this.gitHandler.tenant.repoPrefix(),
        ...
        globalPropertyManager.setGlobalProperty("${config.application.namePrefixForEnvVars}SCM_URL", this.gitHandler.tenant.repoPrefix())
