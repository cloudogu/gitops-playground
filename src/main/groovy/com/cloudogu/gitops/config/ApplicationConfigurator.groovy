...
class ApplicationConfigurator {
	...
	private void addFeatureConfig(Config newConfig) {
		if (newConfig.features.secrets.vault.mode) newConfig.features.secrets.active = true

		if (newConfig.features.mail.smtpAddress || newConfig.features.mail.mailServer) newConfig.features.mail.active = true
