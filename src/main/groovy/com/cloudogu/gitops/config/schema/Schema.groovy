 ...
 */
//@SuppressWarnings('UnnecessaryQualifiedReference') // Implicitly imported groovy.lang with it's CommandLine and Mixin forces ut to use qualified refs 
...
class Schema {
    ...
    static enum VaultMode { dev, prod }
