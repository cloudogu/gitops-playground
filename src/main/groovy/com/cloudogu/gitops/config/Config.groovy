...
class Config {
	...
	static class ContentSchema {
		...
		Set<String> allowedStaticsWhitelist = ['java.lang.String',
		                                       'java.lang.Integer',
		                                       'java.lang.Long',
		                                       'java.lang.Double',
		                                       'java.lang.Float',
		                                       'java.lang.Boolean',
		                                       'java.lang.Math',
		                                       'com.cloudogu.gitops.utils.DockerImageParser'] as Set<String>
	...
	static class ArgoCDSchema {
		...
		@JsonPropertyDescription(HELM_CONFIG_DESCRIPTION)
		HelmConfigWithValues helm = new HelmConfigWithValues(chart: 'argo-cd',
