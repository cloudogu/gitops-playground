...
class RbacDefinitionTest {
    ...
    private final LocalRepository repo = new LocalRepository(config, "my-repo", new FileSystemUtils())
    ...
    void 'renders node access rules in argocd-role only when not on OpenShift'() {
        ...
        LocalRepository tempRepo = new LocalRepository(config, "rbac-test", new FileSystemUtils())
