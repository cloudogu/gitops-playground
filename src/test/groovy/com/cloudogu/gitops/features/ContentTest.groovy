...
class ContentTest {
    ...
    void 'deploys additional image pull secrets for proxy registry'() {
        ...
        k8sClient.commandExecutorForTest.assertExecuted('kubectl get namespace foo-example-apps-staging')
        k8sClient.commandExecutorForTest.assertExecuted('kubectl get namespace foo-example-apps-production')
