...
class ArgoCDDedicatedInstancesTest extends ArgoCDTest {
    ...
    //TODO more tests when finished
    //TODO Fixing other UnitTests
    @Test
    void 'GOP DedicatedInstances Central templating works correctly'() {
        ...
        assertThat(tenantProject['spec']['sourceRepos'][0]).isEqualTo('http://scmm.scm-manager.svc.cluster.local/scm/repo/testPrefix-argocd/argocd')
        assertThat(tenantProject['spec']['sourceRepos'][1]).isEqualTo('http://scmm.scm-manager.svc.cluster.local/scm/repo/testPrefix-argocd/cluster-resources')
