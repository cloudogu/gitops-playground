...
class AirGappedUtilsTest {
    ...
    void 'Prepares repos for air-gapped use'() {
        ...
        assertAirGapped()
        verify(helmClient).template('kube-prometheus-stack', "${rootChartsFolder}/kube-prometheus-stack".toString())
    }
    ...
    AirGappedUtils createAirGappedUtils() {
        new AirGappedUtils(gitRepoFactory, fileSystemUtils, helmClient, gitHandler)
    }
}