...
class HelmClientTest {
	...
	void 'assembles parameters for upgrade'() {
		...
		new HelmClient(commandExecutor).upgrade("the-release", "path/to/chart", [version  : 'the-version',
	...
	void 'runs helm template'() {
		def commandExecutor = new CommandExecutorForTest()
		new HelmClient(commandExecutor).template("the-release", "path/to/chart", [version  : 'the-version',
		                                                                          namespace: 'the-namespace',
		                                                                          values   : 'values.yaml',])
