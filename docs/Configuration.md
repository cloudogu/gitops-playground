...
| `--jenkins-password`         | `jenkins.password`           | String  | ``                          | Mandatory when jenkins-url is set                                                                                                                                                                                                                                                          |
...
| `--password`             | `application.password`             | String             | `QrBJZqUhSSPg`       | Set initial admin passwords                                                                                                                                             |
...
| -                                      | `features.argocd.operatorVersion`           | String                                                        | `0.17`                 | Operator Version to install                                                                                                                                                                                                                                             |
