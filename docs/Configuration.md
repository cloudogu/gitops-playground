...
| `--jenkins-password`         | `jenkins.password`           | String  | `TqMl80IVjBuH`              | Mandatory when jenkins-url is set                                                                                                                                                                                                                                                          |
...
| `--password`             | `application.password`             | String             | `TqMl80IVjBuH`       | Set initial admin passwords                                                                                                                                             |
