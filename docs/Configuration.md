...
| `--jenkins-password` | `jenkins.password` | String | `2RkLYwaLy!P2` | Mandatory when jenkins-url is set |
...
| `--password` | `application.password` | String | `2RkLYwaLy!P2` | Set initial admin passwords |
