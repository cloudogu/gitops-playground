...
| `--jenkins-password`         | `jenkins.password`           | String  | `8mVqsJNzYp8g`              | Mandatory when jenkins-url is set                                                                                                                                                                                                                                                          |
...
| `--password`             | `application.password`             | String             | `8mVqsJNzYp8g`       | Set initial admin passwords                                                                                                                                             |
